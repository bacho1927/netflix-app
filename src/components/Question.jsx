    ...
    return (
        <>
            ...
            <div className="bg-[#2D2D2D] w-[90%] xl:w-[60%]    cursor-pointer" onClick={toggle}>
                ...
                {questionOpened && (
                    <div className={`${questionOpened ? 'opacity-1 transition-height duration-300 ease-in-out' : 'opacity-0'}`}>
                        <div className="border-2 w-full border-black "></div>
                        <p className="text-white text-xl p-6 transition-all duration-600 ease-in-out">{data.paragraph}</p>
