                ...
                <div className='bg-black md:bg-opacity-60 h-[100vh] min-w-[450px]' >
                    ...
                    <div className='bg-black md:bg-opacity-70  min-w-[450px]  md:max-w-[450px] mx-auto'>
                        <div className='p-16  '>
                            ...
                            <InputAnimated inputId='headerInput' labelFor='headerInput' labelText='Email or phone number' duration='duration-100' background='bg-[#333] ' width='w-80' focusedStyles='text-sm top-1 text-gray-300' normalStyles='top-5 text-base text-[#969696] font-semibold  ' textColor='text-white'>

                            </InputAnimated>
                            <InputAnimated inputId='headerInput2' labelFor='headerInput2' labelText='Password' duration='duration-100' background='bg-[#333] ' width='w-80' focusedStyles='text-sm top-1 text-gray-300' normalStyles='top-5 text-base text-[#969696] font-semibold  ' textColor='text-white'>
